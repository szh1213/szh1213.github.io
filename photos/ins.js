    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://qq-1303080949.cos.ap-nanjing.myqcloud.com/img/tmp/min_photos/' + data.link[i];
          var src = 'https://qq-1303080949.cos.ap-nanjing.myqcloud.com/img/tmp/photos/' + data.link[i];
